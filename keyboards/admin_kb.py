...
admin_keyboard.add(admin_load, admin_edit, admin_delete).add(admin_get_menu, admin_get_advanced_menu).add(admin_quit)


admin_edit_keyboard = InlineKeyboardMarkup(row_width=3)
edit_photo = InlineKeyboardButton(text='ФОТО', callback_data='edit_photo')
...
admin_edit_keyboard.add(edit_photo, edit_category, edit_name, edit_description, edit_price).add(admin_back)
